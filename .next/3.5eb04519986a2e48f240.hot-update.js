...
// {
//   info: "ainoa EU-maa jossa aborttia ei hyväksytä missään tilanteessa",
//   country: "Malta"
// },
{
...
//                     if (geography.properties.ISO_A3 == selected) {
//                       alert("CORRECT")
//                     }
//                   }}
//                   geography={geography}
...
//       </div>
//       <div className="cards">
//         {cardInfo.map(({info, country}) => 
//           // <Card 
//           //   onClick={() => {
//           //     console.log("onCLICK CLICKED:",selected)
//           //     setSelected(info.country)
//           //     console.log("AFTER CLICK",selected)
//           //   }}
//           //   key={info.country} 
//           //   props={{...info, style: selected == info.country ? bold : normal, onClick: () => {
//           //     console.log("CLICKED",info.country)
//           //     console.log("SELECTED",selected)
//           //     setSelected(info.country)
//           //     console.log("AFTER CLICK",selected)
//           //   }}}
//           // />
//           <div className="card" key={country} onClick={() => setSelected(country)} style={selected == country ? bold : normal} >
//             <label>{info}</label>
//           </div>
//         )}
//       </div>
...
//# sourceMappingURL=3.5eb04519986a2e48f240.hot-update.js.map